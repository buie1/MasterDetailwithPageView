...
class MasterViewController: UITableViewController {
    ...
    var detailViewController: PageViewController? = nil
    ...
    override func viewDidLoad() {
        ...
        if let split = self.splitViewController {
            ...
            self.detailViewController = (controllers[controllers.count-1] as! UINavigationController).topViewController as? PageViewController
        }
    }
